...
var _commonValues = require("../utils/common-values");
  ...
  function MTableFilterRow() {
    ...
    (0, _defineProperty2["default"])(
      ...
      function (_ref) {
        ...
        var _React$useState = React.useState(
            columnDef[_commonValues.tableData].filterValue || []
          ),
    ...
    (0, _defineProperty2["default"])(
      ...
      function (columnDef) {
        return /*#__PURE__*/ React.createElement(_Checkbox["default"], {
          indeterminate:
            columnDef[_commonValues.tableData].filterValue === undefined,
          checked: columnDef[_commonValues.tableData].filterValue === "checked",
          onChange: function onChange() {
            var val;

            if (columnDef[_commonValues.tableData].filterValue === undefined) {
              val = "checked";
            } else if (
              columnDef[_commonValues.tableData].filterValue === "checked"
            ) {
              val = "unchecked";
            }
    ...
    (0, _defineProperty2["default"])(
      ...
      function (columnDef) {
        ...
        return /*#__PURE__*/ React.createElement(_TextField["default"], {
          ...
          value: columnDef[_commonValues.tableData].filterValue || "",
    ...
    (0, _defineProperty2["default"])(
      ...
      function (columnDef) {
        ...
        var pickerProps = {
          value: columnDef[_commonValues.tableData].filterValue || null,
      ...
      value: function render() {
        ...
        var columns = this.props.columns
          .filter(function (columnDef) {
            return (
              !columnDef.hidden &&
              !(columnDef[_commonValues.tableData].groupOrder > -1)
            );
          })
          .sort(function (a, b) {
            return (
          ...
          .map(function (columnDef) {
            return /*#__PURE__*/ React.createElement(
              _TableCell["default"],
              {
                key: columnDef[_commonValues.tableData].id,
        ...
        this.props.columns
          .filter(function (columnDef) {
            return columnDef[_commonValues.tableData].groupOrder > -1;
          })
          .forEach(function (columnDef) {
            columns.splice(
              ...
              /*#__PURE__*/ React.createElement(_TableCell["default"], {
                padding: "checkbox",
                key: "key-group-filter" + columnDef[_commonValues.tableData].id,
              })
            );
          });
        return /*#__PURE__*/ React.createElement(
