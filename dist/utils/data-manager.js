...
var DataManager = /*#__PURE__*/ (function () {
  function DataManager() {
    ...
    (0, _defineProperty2["default"])(this, "startCellEditable", function (
      ...
      rowData[_commonValues.tableData].editCellList = [].concat(
        (0, _toConsumableArray2["default"])(
          rowData[_commonValues.tableData].editCellList || []
        ),
        [columnDef]
      );
    });
    (0, _defineProperty2["default"])(this, "finishCellEditable", function (
      ...
      if (rowData[_commonValues.tableData].editCellList) {
        var index = rowData[_commonValues.tableData].editCellList.findIndex(
          function (c) {
            return (
              c[_commonValues.tableData].id ===
              columnDef[_commonValues.tableData].id
            );
          }
        );

        if (index !== -1) {
          rowData[_commonValues.tableData].editCellList.splice(index, 1);
        }
      }
    });
    ...
    (0, _defineProperty2["default"])(this, "onBulkEditRowChanged", function (
      ...
      _this.bulkEditChangedRows[oldData[_commonValues.tableData].id] = {
        oldData: oldData,
        newData: newData,
      };
    });
    (0, _defineProperty2["default"])(this, "expandTreeForNodes", function (
      ...
      data.forEach(function (row) {
        ...
        while (_this.parentFunc(currentRow, _this.data)) {
          ...
          if (parent) {
            parent[_commonValues.tableData].isTreeExpanded = true;
          }
      ...
      if (_this.isDataType("tree")) {
        var node = path.reduce(
          function (result, current) {
            return (
              result &&
              result[_commonValues.tableData] &&
              result[_commonValues.tableData].childRows &&
              result[_commonValues.tableData].childRows[current]
            );
          },
          {
            tableData: {
      ...
      if (_this.applyFilters) {
        _this.columns
          .filter(function (columnDef) {
            return columnDef[_commonValues.tableData].filterValue;
          })
  ...
  (0, _createClass2["default"])(DataManager, [
    {
      ...
      value: function setData(data) {
        ...
        this.data = data.map(function (row, index) {
          row[_commonValues.tableData] = (0, _objectSpread2["default"])(
            {},
            row[_commonValues.tableData],
            {
              id: index,
            }
          );

          if (row[_commonValues.tableData].checked) {
    ...
    },
    {
      ...
      value: function setColumns(columns) {
        ...
        this.columns = columns.map(function (columnDef, index) {
          columnDef[_commonValues.tableData] = (0, _objectSpread2["default"])(
            {
              columnOrder: index,
            ...
            columnDef[_commonValues.tableData],
            {
              id: index,
            }
          );
          ...
          if (
            columnDef[_commonValues.tableData] !== undefined &&
            columnDef[_commonValues.tableData].width !== undefined
          ) {
            usedWidth.push(columnDef[_commonValues.tableData].width);
          }
        ...
        undefinedWidthColumns.forEach(function (columnDef) {
          columnDef[_commonValues.tableData].width = columnDef[
            _commonValues.tableData
          ].initialWidth = "calc((100% - "
            .concat(usedWidth, ") / ")
    ...
    },
    {
      ...
      value: function changeFilterValue(columnId, value) {
        this.columns[columnId][_commonValues.tableData].filterValue = value;
        this.filtered = false;
      },
    },
    {
      ...
      value: function changeRowSelected(checked, path) {
        ...
        rowData[_commonValues.tableData].checked = checked;
        this.selectedCount = this.selectedCount + (checked ? 1 : -1);

        var checkChildRows = function checkChildRows(rowData) {
          if (rowData[_commonValues.tableData].childRows) {
            rowData[_commonValues.tableData].childRows.forEach(function (
              childRow
            ) {
              if (childRow[_commonValues.tableData].checked !== checked) {
                childRow[_commonValues.tableData].checked = checked;
    ...
    },
    {
      ...
      value: function changeDetailPanelVisibility(path, render) {
        ...
        if (
          (
            rowData[_commonValues.tableData].showDetailPanel || ""
          ).toString() === render.toString()
        ) {
          rowData[_commonValues.tableData].showDetailPanel = undefined;
        } else {
          rowData[_commonValues.tableData].showDetailPanel = render;
        }
    ...
    },
    {
      ...
      value: function changeRowEditing(rowData, mode) {
        if (rowData) {
          rowData[_commonValues.tableData].editing = mode;

          if (this.lastEditingRow && this.lastEditingRow != rowData) {
            this.lastEditingRow[_commonValues.tableData].editing = undefined;
          }
      ...
      value: function changeAllSelected(checked) {
        ...
        if (this.isDataType("group")) {
            ...
            data.forEach(function (element) {
              if (element.groups.length > 0) {
                ...
                element.data.forEach(function (d) {
                  d[_commonValues.tableData].checked = d[
                    _commonValues.tableData
                  ].disabled
                    ? false
                    : checked;
          ...
          this.searchedData.map(function (row) {
            row[_commonValues.tableData].checked = row[_commonValues.tableData]
              .disabled
              ? false
              : checked;
            return row;
    ...
    },
    {
      ...
      value: function changeGroupOrder(columnId) {
        var column = this.columns.find(function (c) {
          return c[_commonValues.tableData].id === columnId;
        });

        if (column[_commonValues.tableData].groupSort === "asc") {
          column[_commonValues.tableData].groupSort = "desc";
        } else {
          column[_commonValues.tableData].groupSort = "asc";
        }
    ...
    },
    {
      ...
      value: function changeTreeExpand(path) {
        var rowData = this.findDataByPath(this.sortedData, path);
        rowData[_commonValues.tableData].isTreeExpanded = !rowData[
          _commonValues.tableData
        ].isTreeExpanded;
      },
    },
    ...
    },
    {
      ...
      value: function changeByDrag(result) {
        ...
        var groups = this.columns
          .filter(function (col) {
            return col[_commonValues.tableData].groupOrder > -1;
          })
          .sort(function (col1, col2) {
            return (
              col1[_commonValues.tableData].groupOrder -
              col2[_commonValues.tableData].groupOrder
            );
          });
        ...
        if (
          ...
          var newGroup = this.columns.find(function (c) {
            return c[_commonValues.tableData].id == result.draggableId;
          });
          ...
          removeGroup[_commonValues.tableData].groupOrder = undefined;
          ...
          var sorted = this.columns
            .sort(function (a, b) {
              return (
                a[_commonValues.tableData].columnOrder -
                b[_commonValues.tableData].columnOrder
              );
            })
            .filter(function (column) {
              return column[_commonValues.tableData].groupOrder === undefined;
            });
          ...
          for (var _i = 0; _i < colsToMov.length; _i++) {
            colsToMov[_i][_commonValues.tableData].columnOrder =
              effectiveStart + _i;
          }
        ...
        for (var _i2 = 0; _i2 < groups.length; _i2++) {
          groups[_i2][_commonValues.tableData].groupOrder = start + _i2;
        }
    ...
    },
    {
      ...
      value: function onColumnResized(id, additionalWidth) {
        var column = this.columns.find(function (c) {
          return c[_commonValues.tableData].id === id;
        });
        if (!column) return;
        var nextColumn = this.columns.find(function (c) {
          return c[_commonValues.tableData].id === id + 1;
        });
        ...
        column[_commonValues.tableData].additionalWidth = additionalWidth;
        column[_commonValues.tableData].width = "calc("
          .concat(column[_commonValues.tableData].initialWidth, " + ")
          .concat(column[_commonValues.tableData].additionalWidth, "px)"); // nextColumn[tableData].additionalWidth = -1 * additionalWidth;
      ...
      value: function isDataType(type) {
        ...
        if (this.parentFunc) {
          ...
          this.columns.find(function (a) {
            return a[_commonValues.tableData].groupOrder > -1;
          })
        ) {
          dataType = "group";
        }
    ...
    },
    {
      ...
      value: function sortList(list) {
        ...
        var columnDef = this.columns.find(function (_) {
          return _[_commonValues.tableData].id === _this4.orderBy;
        });
        var result = list;
    ...
    },
    {
      ...
      value: function treefyData() {
        ...
        this.data.forEach(function (a) {
          return (a[_commonValues.tableData].childRows = null);
        });
        this.treefiedData = [];
        ...
        if (
          ...
          this.data.forEach(function (row) {
            row[_commonValues.tableData].isTreeExpanded = false;
        ...
        var addRow = function addRow(rowData) {
          rowData[_commonValues.tableData].markedForTreeRemove = false;

          var parent = _this6.parentFunc(rowData, _this6.data);

          if (parent) {
            parent[_commonValues.tableData].childRows =
              parent[_commonValues.tableData].childRows || [];

            if (!parent[_commonValues.tableData].childRows.includes(rowData)) {
              parent[_commonValues.tableData].childRows.push(rowData);

              _this6.treefiedDataLength++;
            }

            addRow(parent);
            rowData[_commonValues.tableData].path = [].concat(
              (0, _toConsumableArray2["default"])(
                parent[_commonValues.tableData].path
              ),
              [parent[_commonValues.tableData].childRows.length - 1]
            );
            _this6.treeDataMaxLevel = Math.max(
              _this6.treeDataMaxLevel,
              rowData[_commonValues.tableData].path.length
            );
          } else {
            if (!_this6.treefiedData.includes(rowData)) {
              ...
              _this6.treefiedDataLength++;
              rowData[_commonValues.tableData].path = [
        ...
        var markForTreeRemove = function markForTreeRemove(rowData) {
          ...
          rowData[_commonValues.tableData].path.forEach(function (pathPart) {
            if (
              pointer[_commonValues.tableData] &&
              pointer[_commonValues.tableData].childRows
            ) {
              pointer = pointer[_commonValues.tableData].childRows;
            }

            pointer = pointer[pathPart];
          });

          pointer[_commonValues.tableData].markedForTreeRemove = true;
        };
        ...
        var traverseChildrenAndUnmark = function traverseChildrenAndUnmark(
          ...
          if (rowData[_commonValues.tableData].childRows) {
            rowData[_commonValues.tableData].childRows.forEach(function (row) {
        ...
        this.data.forEach(function (rowData) {
          if (
            ...
            if (rowData[_commonValues.tableData].isTreeExpanded === undefined) {
              var isExpanded =
                typeof _this6.defaultExpanded === "boolean"
                  ? _this6.defaultExpanded
                  : _this6.defaultExpanded(rowData);
              rowData[_commonValues.tableData].isTreeExpanded = isExpanded;
            }
          }

          var hasSearchMatchedChildren =
            rowData[_commonValues.tableData].isTreeExpanded;
        ...
        var traverseTreeAndDeleteMarked = function traverseTreeAndDeleteMarked(
          ...
          for (var i = rowDataArray.length - 1; i >= 0; i--) {
            ...
            if (item[_commonValues.tableData].childRows) {
              traverseTreeAndDeleteMarked(
                item[_commonValues.tableData].childRows
              );
            }

            if (item[_commonValues.tableData].markedForTreeRemove)
      ...
      value: function sortData() {
        ...
        if (this.isDataType("group")) {
          ...
          var sortGroups = function sortGroups(list, columnDef) {
            if (columnDef.customSort) {
              return list.sort(
                columnDef[_commonValues.tableData].groupSort === "desc"
                  ? function (a, b) {
          ...
          if (this.orderBy != -1) {
            ...
            var sortTree = function sortTree(list) {
              list.forEach(function (item) {
                if (item[_commonValues.tableData].childRows) {
                  item[_commonValues.tableData].childRows = _this7.sortList(
                    item[_commonValues.tableData].childRows
                  );
                  sortTree(item[_commonValues.tableData].childRows);
                }
              });
            };
