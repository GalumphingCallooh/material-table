...
(function (global, factory) {
  ...
  if (
    ...
    (0, _typeof2["default"])(module.exports) === "object"
  ) {
  ...
  var ES6 =
    (0, _typeof2["default"])(global.ES6) === "object"
      ? global.ES6
      : (global.ES6 = {});
  ...
  var es6FunctionPrototypeHasInstanceSymbol = function es6FunctionPrototypeHasInstanceSymbol(
    instance
  ) {
  ...
  var es6InstanceOfOperator = function es6InstanceOfOperator(
    object,
    constructor
  ) {
    ...
    if (typeof hasInstanceSymbolProp === "undefined") {
      ...
      throw new TypeError(
        (0, _typeof2["default"])(hasInstanceSymbolProp) + " is not a function"
      );
    } else {
  ...
  var es6ObjectPrototypeToString = function toString() {
    if (this === undefined || this === null) return objectToString.call(this); // Add support for @@toStringTag symbol

    if (typeof this[_Symbol.toStringTag] === "string")
      return "[object " + this[_Symbol.toStringTag] + "]";
    else return objectToString.call(this);
  };

  var es6ArrayPrototypeConcat = function concat() {
    if (this === undefined || this === null)
      throw new TypeError("Array.prototype.concat called on null or undefined"); // Boxing 'this' value to wrapper object
  ...
  var es6ForOfLoop = function es6ForOfLoop(iterable, callback, thisArg) {
    ...
    if (typeof iterable[_Symbol.iterator] !== "function")
